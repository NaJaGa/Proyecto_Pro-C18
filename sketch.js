...
function preload(){
  ...
  gameoverSoun = loadSound("gameover.mp3");
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    console.log(monster.velocityX + " es la velocidad del Mounstro");
  }
}
...
function fruits(){
  if(World.frameCount%80===0){
    ...
    console.log(fruit.velocityX+ " es la velocidad de la Fruta");
  }
}
